        ...
        <header className="header">
            <div className="header__wrapper">
                <div className="header__background">
                    ...
                    <div className="tab">
                        <h1>
                            Производственные практики играют важную роль в образовательном процессе и подготовке специалистов. Они позволяют студентам и молодым специалистам получить практический опыт, который невозможно приобрести только в рамках теоретических занятий.
                            <div className="tickers">
                                <div className="ticker">
                                    {/* Повторяющийся текст */}
                                    {Array(14).fill(<h2 className="ticker__head">ПРАКТИКА</h2>)}
                                </div>
                            </div>
                        </h1>
                    </div>
