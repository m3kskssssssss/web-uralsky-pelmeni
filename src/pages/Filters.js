...
const Filters = ({ onFilter }) => {
    ...
    const [isVisible, setIsVisible] = useState(false); // Новое состояние для видимости фильтров

    const handleFilterToggle = () => {
        setIsVisible(!isVisible); // Переключаем видимость фильтров
    };
    ...
    return (
        <div className="filters">
            ...
            {isVisible && ( // Условно рендерим фильтры
                <div>
                    <div>
                        <label>Отрасль:</label>
